...
if(isset($_POST['submit']))
 ...
 $eid=$_GET['editid'];
    ...
    {
	echo "<script>alert('Service Not Updated. Something Went Wrong!');</script>";
    }
			...
			<div class="sidebar-inner slimscroll">
				<div id="sidebar-menu" class="sidebar-menu">
					<ul>
						...
						<li> 
							<a href="speciality.php"><i class="fe fe-user-plus"></i> <span>Specialities</span></a>
						</li>
						<li> 
						...
						<li class="submenu">
							...
							<li><a href="add_service.php">Add service</a></li>
							   <li class="active"><a href="manage_service.php">Manage service</a></li>
							</ul>
					</ul>
				</div>
			</div>
							...
							<form method="post">
                            	...
                            	<div class="row form-row">
                                	...
                                	<div class="col-md-6">
                                    	<div class="form-group">
                                        	<label>Cost</label>
                                        	<input type="text" class="form-control" name="cost" id="cost" placeholder="*Kshs" value="<?php  echo $row['Cost'];?>" required="true">
                                    	</div>
                                	</div>
									<?php } ?>									
