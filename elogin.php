<?php 
 ...
 if(isset($_POST['login'])) {
	...
	$query=mysqli_query($con,"select ID from tblemployee where  UserName='$adminuser' && Password='$password' ");
					...
					<div class="col-12 col-md-8 col-lg-6 col-xl-5">
						<div class="card shadow-2-strong" style="border-radius: 1rem;">
							<div class="card-body p-5 text-center">
								<h3 class="mb-5">Employee Login</h3>
								<hr class="my-4">
								<form action="" method ="post">
									<div class="form-group form-focus">
										<input type="text" class="form-control floating" placeholder="Username" name="username"required>
									</div>
									<div class="form-group form-focus">
										<input type="password" class="form-control floating" placeholder="Password" name="password"required>
									</div>
